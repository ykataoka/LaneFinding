...
#        cv2.imwrite('test_preprocess/straight1_undistort.jpg', undist)
...
#        plt.savefig('examples/threshold_binary.png', dpi=300)
#        plt.show()
        ...
        # tmp plot (img transform)
        top_down, birdM, birdMinv = corners_unwarp(comba, 2, 2, mtx, dist)
        plt.imshow(top_down, cmap='gray')
        plt.savefig('examples/img_top_down.png', dpi=300)
        plt.show()
...
#        plt.show()
        ...
        print(L_Line.diffs, R_Line.diffs)
